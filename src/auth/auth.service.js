...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signUp = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var users, salt, hash, verified, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.findAll(body.email)];
                    case 1:
                        users = _a.sent();
                        if (users.length) {
                    ...
                    case 3:
                        hash = _a.sent();
                        verified = { email: body.email, password: hash };
                        return [4 /*yield*/, this.userService.createUser(verified)];
                    case 4:
                        user = _a.sent();
    ...
    AuthService.prototype.signIn = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.findAll(email)];
                    case 1:
                        user = (_a.sent())[0];
                        if (!user) {
