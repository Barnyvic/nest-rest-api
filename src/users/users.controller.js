...
var serialize_interceptors_1 = require("../../../../../../../../src/interceptors/serialize.interceptors");
...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.signInUser = function (createUserdto) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.signIn(createUserdto.email, createUserdto.password)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, user];
                }
    ...
    UsersController.prototype.findUserById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.findOne(parseInt(id))];
                    case 1:
                        result = _a.sent();
                        if (!result)
    ...
    __decorate([
        ...
        __param(0, (0, decorators_1.Body)())
    ], UsersController.prototype, "signInUser");
    __decorate([
        (0, decorators_1.Get)('/:id'),
        __param(0, (0, decorators_1.Param)('id'))
    ], UsersController.prototype, "findUserById");
    __decorate([
    ...
    UsersController = __decorate([
        ...
        (0, serialize_interceptors_1.Serialize)(user_dto_1.UserDto) // used  exclude  some object from showing in the browser
    ], UsersController);
