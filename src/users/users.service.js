...
var UsersService = /** @class */ (function () {
    function UsersService(repository) {
    ...
    UsersService.prototype.findOne = function (id) {
        var user = this.repository.findOne({ where: { id: id } });
        return user;
    };
    UsersService.prototype.findAll = function (email) {
        return this.repository.find({ where: { email: email } });
    };
    UsersService.prototype.updateUser = function (id, attribute) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.repository.remove(user)];
                }
            });
        });
    };
